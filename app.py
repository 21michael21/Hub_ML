...
from core.ui.common import (
    STATUS_CHIP_CLASSES,
    UI_COMPONENT_RULES,
    internal_target_query_href,
    internal_target_tab_name,
    normalize_chip_status,
    render_action_button,
    render_action_card,
    render_card,
    render_clickable_row,
    render_disabled_chip,
    render_empty_state,
    render_flat_section_header,
    render_html,
    render_internal_action_row,
    render_metric_tile,
    render_section_eyebrow,
    render_section_eyebrow_block,
    render_section_header,
    render_static_chip,
    render_status_chip,
    render_warning_state,
    safe_widget_key,
    theory_note_query_href,
    ui_component_rules,
)
...
STATIC_STYLES_PATH = PROJECT_ROOT / "static" / "styles.css"
...
def load_cached_stylesheet(path: str) -> str:
    return Path(path).read_text(encoding="utf-8")


def load_stylesheet() -> str:
    if os.environ.get("HUBML_DEV_CSS") == "1":
        return STATIC_STYLES_PATH.read_text(encoding="utf-8")
    return load_cached_stylesheet(str(STATIC_STYLES_PATH))
